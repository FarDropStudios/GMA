...
EntityFace = EntityEnemy.extend({
	...
	ig.game.leaderboard.post( { score:  ig.game.timerClocker}, function( response ) {
	    // Callback
	...
	var options = { // all of these are optional
	    html: "<strong>Survivor</strong>", // Optional, any custom html you want to show below the name
