...
EntityPlayer = ig.Entity.extend({
	...
	update : function() {
		...
		if (ig.input.pressed('shoot left')) {
			ig.game.spawnEntity(EntityProjectile, this.pos.x, this.pos.y, {facing:'left'});
		} else if (ig.input.pressed('shoot right')) {
			ig.game.spawnEntity(EntityProjectile, this.pos.x, this.pos.y, {facing:'right'});
		} else if (ig.input.pressed('shoot up')) {
			ig.game.spawnEntity(EntityProjectile, this.pos.x, this.pos.y, {facing:'up'});
