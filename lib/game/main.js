...
MyGame = ig.Game.extend({
	...
	draw: function() {
		...
		if(ig.game.currentLevel === LevelBedroom) {
			...
			this.gmaFont.draw("WASD to attack", 350, 650, ig.Font.ALIGN.CENTER);
		} 
			...
			this.gmaFont.draw("im watching my program. shut these dogs up.", 350, 650, ig.Font.ALIGN.CENTER);
		}
			...
			this.gmaFont.draw("where did u leav poor gma y did u", 350, 650, ig.Font.ALIGN.CENTER);
		} 
	}
});
