...
MyGame = ig.Game.extend({
	...
	fontTest: new ig.Font('media/fontTest.png'),
	...
	init: function() {
		...
		this.loadLevel(LevelLivingRoom);
	},
	...
	draw: function() {
		...
		if(ig.game.currentLevel === LevelBedroom) {
			this.fontTest.draw("E-mail cousin Joe a picture of the cat!", 100, 100, ig.Font.ALIGN.CENTER);
		}
		this.font.draw( 'Gma', 900, 710, ig.Font.ALIGN.CENTER );
	}
});
